...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.images sd_setImageWithURL:[NSURL URLWithString:@"http://dev.apppartner.com/AppPartnerProgrammerTest/images/drew_avatar.png"]placeholderImage:[UIImage imageNamed:@"placeholder"]];
