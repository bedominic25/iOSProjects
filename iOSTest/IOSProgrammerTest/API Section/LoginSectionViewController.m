...
- (IBAction)logIn:(id)sender {
    ...
    NSDate * date = [[NSDate alloc]init];
     ...
     [manager POST:@"http://dev.apppartner.com/AppPartnerProgrammerTest/scripts/login.php" parameters:parameters progress:nil success:^(NSURLSessionTask *task, id responseObject) {
         ...
         NSString * myMessage = [NSString stringWithFormat:@" Time Response is %f %@", executionTime, responseObject];
         
         UIAlertController * aleart = [UIAlertController alertControllerWithTitle:@"Not Successful Login"
                                                                          message:myMessage
